	...
	<view class="flex align-center justify-center">
		<view style="width: 96%;" class="mt-2">
			<u-form :error-type="errorType" :model="form" ref="uForm">
				<u-form-item :label-style="labelStyle" :border-bottom="false" label="wifi名称:" label-width="120" prop="wifiName">
					<u-input style="border-bottom: 1rpx solid #d7d7d7;" v-model="form.wifiName" height="100" placeholder="请输入WiFI名称" />
				</u-form-item>
				<u-form-item :label-style="labelStyle" :border-bottom="false" label="wifi密码:" label-width="120" prop="wifiPwd"
				 style="margin-top: 30rpx;">
					<u-input style="border-bottom: 1rpx solid #d7d7d7;" type="password" v-model="form.wifiPwd" height="100"
					 placeholder="请输入WiFi密码" />
				</u-form-item>
			</u-form>
			<u-button hover-class="none" :hair-line="false" type="success" :custom-style="customBtnStyle" @click="handleBtnClick">配置探头</u-button>
		</view>
		<!-- 探头连接提醒 -->
					...
					wifiName: [{
						...
						},
						{
							validator: (rule, value, callback) => {
								return !this.$u.test.chinese(this.form.wifiName);
							},
							message: 'wifi名称不能是中文'
						}
					],
